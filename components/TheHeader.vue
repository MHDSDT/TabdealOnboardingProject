<template>
  <header>
    <nav class="border-gray-200 px-1 lg:px-6 py-2.5 bg-[#111214] w-full" dir="rtl">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="#" class="flex items-center">
          <img src="https://tabdeal.org/tabdeal-logo-dark.svg" class="mr-3 h-6 sm:h-9" alt="Tabeal Logo"/>
        </a>
        <div class="flex items-center lg:order-2">
          <a href="#"
             class="text-yellow-500 hover:bg-[#231f13] font-medium rounded text-sm px-4 lg:px-5 py-2
               lg:py-2.5 mr-2 ">ورود</a>
          <a href="#"
             class="bg-yellow-500 hover:bg-[#e0ac0c] font-medium rounded text-sm px-4 lg:px-5 py-2
               lg:py-2.5 mr-2 ">ثبت
            نام</a>
          ...
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <a href="#"
                 class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50
                   ...
                   dark:border-gray-700">Company</a>
            </li>
            <li>
              <a href="#"
                 class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50
                   lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400
                   lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent
                   dark:border-gray-700">Marketplace</a>
            </li>
            <li>
              <a href="#"
                 class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50
            ...
            <li>
              <a href="#"
                 class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50
                   lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400
                   g:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent
